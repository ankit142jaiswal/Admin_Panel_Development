...
<div className='col-1'></div>
        <div className='col-5 border p-5 text-start mx-1 ' style={{  fontSize: "larger", backgroundColor: "white", fontWeight: "bolder", boxShadow: "0 0 10px 1px rgba(0, 0, 0, 0.2)", borderRadius: "5px" }}>
          ...
          dolor sit amet. nihil voluptatem inventore tempora officiis labore harum nam minima adipisci illo rem nulla corrupti. Explicabo consectetur distinctio minima.
        </div>
